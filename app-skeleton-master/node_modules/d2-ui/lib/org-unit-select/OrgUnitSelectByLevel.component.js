...
var OrgUnitSelectByLevel = function (_React$Component) {
    ...
    function OrgUnitSelectByLevel(props, context) {
        ...
        _this.handleChangeLevel = _this.handleChangeLevel.bind(_this);
    ...
    _createClass(OrgUnitSelectByLevel, [{
        ...
        value: function handleChangeLevel(event) {
        ...
        value: function handleSelectAll() {
            ...
            this.getOrgUnitsForLevel(this.state.level).then(function (orgUnits) {
