    ...
    _createClass(FormBuilder, [{
        ...
        value: function renderFields() {
            ...
            return this.props.fields.map(function (field) {
                ...
                var errorTextProp = _ref.errorTextProp;

                var props = _objectWithoutProperties(_ref, ['errorTextProp']);
                ...
                return _react2.default.createElement(
                    ...
                    fieldState.validating ? _react2.default.createElement(_circularProgress2.default, { mode: 'indeterminate', size: 0.33, style: styles.progress }) : undefined,
                    _react2.default.createElement(field.component, _extends({
...
FormBuilder.propTypes = {
    fields: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.shape({
        ...
        props: _react2.default.PropTypes.shape({
            changeEvent: _react2.default.PropTypes.oneOf(['onChange', 'onBlur'])
        }),
        validators: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.shape({
            validator: _react2.default.PropTypes.func.isRequired,
            message: _react2.default.PropTypes.string.isRequired
        })),
        asyncValidators: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.func.isRequired),
        validatingLabelText: _react2.default.PropTypes.string
    })).isRequired,
    validatingLabelText: _react2.default.PropTypes.string,
    validatingProgressStyle: _react2.default.PropTypes.object,
    onUpdateField: _react2.default.PropTypes.func.isRequired,
    onUpdateFormStatus: _react2.default.PropTypes.func,
    style: _react2.default.PropTypes.object,
    fieldWrapStyle: _react2.default.PropTypes.object
};
